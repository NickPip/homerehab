...
const translations: Record<string, Translations> = {
  ...
  ka: {
    ...
    hero: {
      ...
      title3: "სახლში",
      description:
        "ფიზიოთერაპევტის გამოძახება ბინაზე თბილისში. დაიბრუნეთ მოძრაობის თავისუფლება კლინიკაში ვიზიტის გარეშე — ლიცენზირებული სპეციალისტი მოვა თქვენთან და სრულ სარეაბილიტაციო კურსს თქვენსავე სახლში ჩაგიტარებთ.",
      callButton: "დარეკეთ",
      cta: "მიიღეთ უფასო კონსულტაცია",
      trustBadge: "ფიზიოთერაპევტის გამოძახება ბინაზე — თბილისის ნებისმიერ რაიონში",
      clients: "900+ პაციენტი ორივე სპეციალისტთან",
    },
    services: {
      badge: "რას გთავაზობთ",
      title: "ფიზიო თერაპია და რეაბილიტაცია ბინაზე გამოძახებით",
      subtitle:
        "პროგრამები, რომლებსაც ბინაზე გამოძახებით ვატარებთ თბილისში — თქვენი დიაგნოზისა და საჭიროებების მიხედვით",
      ...
      steps: [
        {
          ...
          description:
            "დაგვირეკავთ და აღწერთ პრობლემას. გეტყვით, შეესაბამება თუ არა თქვენს შემთხვევას ბინაზე გამოძახება, რომელი პროგრამა გჭირდებათ და რა ეღირება ვიზიტი — ჯავშნამდე.",
        },
        {
    ...
    callback: {
      badge: "გამოგვიძახეთ",
      title: "ფიზიოთერაპევტის გამოძახება ბინაზე",
      subtitle:
        "შეავსეთ ფორმა და გამოძახების მოთხოვნა WhatsApp-ში გაიხსნება, გასაგზავნად მზად. ან უბრალოდ დაგვირეკეთ — სამუშაო საათებში ყოველთვის ვპასუხობთ.",
    ...
    coverage: {
      ...
      title: "ფიზიოთერაპევტის გამოძახება თბილისის ყველა რაიონში",
      description:
        "ჩვენი ფიზიოთერაპევტები ბინაზე დადიან მთელ თბილისსა და მიმდებარე დასახლებებში. კლინიკამდე მისვლა და რიგში ლოდინი აღარ გჭირდებათ: სპეციალისტი აღჭურვილობით მოდის თქვენთვის შერჩეულ დროს და სეანსს თქვენსავე ბინაში ატარებს.",
    ...
    footer: {
      tagline:
        "ფიზიო თერაპია და რეაბილიტაცია ბინაზე გამოძახებით — ლიცენზირებული ფიზიოთერაპევტები თბილისში. თქვენი გამოჯანმრთელება, ჩვენი ვალდებულება.",
      quickLinks: {
